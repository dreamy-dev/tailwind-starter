...
export default function CooperationBecome() {
  return (
    <>
      ...
      <ContentWidth>
        <div className="py-8 mx-auto col-span-12">
      ...
      <ContentWidth>
        <div className="gap-8 py-8 mx-auto col-span-12 xl:grid">
