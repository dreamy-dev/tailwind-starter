...
export async function POST(request, res) {
    ...
    const url = `https://us14.list-manage.com/contact-form/post?u=7e29f428e402a1b5e2a54d074&form_id=2e74855d6562cb5c25c57cd2c93d2fdf`
    try {
        ...
        return NextResponse.json({ success: response.stack, status: err.status });
    }
    catch (err) {
