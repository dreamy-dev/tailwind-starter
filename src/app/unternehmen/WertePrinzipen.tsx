export default function WertePrinzipen() {
  return (
    <section className="bg-white">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">
            Stadler auf einen Blick
          </h2>
          <p className="text-gray-500 sm:text-xl">
            Prinzipien, Werte und Vision von Stadler in Bezug auf das gesamte
            Unternehmen
          </p>
        </div>
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:h-12 lg:w-12">
              <svg
                className="mb-2 w-10 h-10 text-primary md:w-12 md:h-12 dark:text-primary-500"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:h-12 lg:w-12 dark:bg-primary-900">
              <svg
                className="mb-2 w-10 h-10 text-primary md:w-12 md:h-12 "
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
