...
export default function History_Proposal() {
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
    <div className="max-w-3xl mx-auto space-y-4 text-center">
      ...
      <span
        className="bg-primary-200 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">
    ...
    <div className="grid grid-cols-1 mt-12 -mx-8 lg:mt-16 lg:grid-cols-3 gap-y-12">
      <div className="px-8 space-y-12">
        ...
        <div className="space-y-4">
          <span
            className="bg-primary-600 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">
            <svg aria-hidden="true" className="w-3 h-3 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
              fill="currentColor">
              <path fill-rule="evenodd"
                d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
          ...
          <div className="flex items-center gap-3">
            <img className="object-cover w-12 h-12 rounded-full shrink-0" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="" />
            <div>
        ...
        <div className="space-y-4">
          <span
            className="bg-primary-700 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">
            <svg aria-hidden="true" className="w-3 h-3 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
              fill="currentColor">
              <path fill-rule="evenodd"
                d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
        ...
        <div className="p-4 space-y-4 bg-gray-100 rounded-lg dark:bg-gray-800">
          <span
            className="bg-primary-200 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">
            <svg aria-hidden="true" className="w-3 h-3 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
              fill="currentColor">
          ...
          <h4 className="text-xl font-bold text-gray-900 dark:text-white">
            <a href="#" className="hover:underline">Coffee & networking</a>
          </h4>
          <div>
            ...
            <div className="flex flex-wrap items-center mt-2 gap-x-6 gap-y-4">
              <img className="object-contain w-auto h-5" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/customers/microsoft-grayscale.svg"
                alt="" />
              <img className="object-contain w-auto h-5" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/customers/slack-grayscale.svg"
                alt="" />
              <img className="object-contain w-auto h-7" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/customers/spotify-grayscale.svg"
                alt="" />
              <img className="object-contain w-auto h-7" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/customers/salesforce-grayscale.svg"
                alt="" />
              <img className="object-contain w-auto h-5" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/customers/google-grayscale.svg"
                alt="" />
              <img className="object-contain w-auto h-5" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/customers/sap-grayscale.svg"
                alt="" />
            </div>
          </div>
        </div>
      ...
      <div className="px-8 space-y-12 border-l border-r border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-4">
          ...
          <h4 className="text-xl font-bold text-gray-900 dark:text-white">
            <a href="#" className="hover:underline">Women in Streaming Media Networking</a>
          </h4>
          <div className="flex items-center gap-3">
            <img className="object-cover w-12 h-12 rounded-full shrink-0"
        ...
        <div className="space-y-4">
          ...
          <h4 className="text-xl font-bold text-gray-900 dark:text-white">
            <a href="#" className="hover:underline">The importance of platform optimisation in times of expensive ads</a>
          </h4>
          <div className="flex items-center gap-3">
            <img className="object-cover w-12 h-12 rounded-full shrink-0"
