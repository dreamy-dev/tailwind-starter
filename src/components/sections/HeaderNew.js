                    ...
                    <motion.div className="col-span-12 flex flex-col-reverse lg:flex-col">
                        ...
                        <div className="py-2 lg:flex lg:justify-between">
                            ...
                            <motion.nav
                                ...
                                className="flex flex-col justify-start overflow-hidden font-semibold text-primarySolid-800 [--responsive-height:0px] [--responsive-min-height:0px] [--responsive-opacity:0%] lg:mt-0 lg:flex-row lg:space-y-0 lg:[--responsive-height:80px] lg:[--responsive-min-height:80px] lg:[--responsive-opacity:100%]"
                            >
