        ...
        <section {...storyblokEditable(blok)} className="bg-white my-20 ">
            <ContentWidth>
                <div className="col-span-12">
                    <H2 styles="mb-4">{blok.title}</H2>
                    <Text className="font-light text-white sm:text-xl">
                        {blok.description}
                    </Text>
                            ...
                            <form action="https://stadlerrail.us14.list-manage.com/subscribe/post?u=7e29f428e402a1b5e2a54d074&amp;id=abef8b12b4&amp;f_id=00b922e3f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank">
                                <div id="mc_embed_signup_scroll" className="items-center space-y-4 flex-col">
                                    <div className="grid grid-cols-1 gap-4 lg:gap-4 lg:grid-cols-2 items-center">
                                        ...
                                        <div className="mc-field-group relative w-full">
                                            <label for="mce-LNAME" className="mb-2 text-sm font-medium">{blok.lname_label} <span className="asterisk">*</span></label>
                                            <input type="text" name="LNAME" value={lastName} onChange={e => setLastName(e.target.value)} className="required text block p-3  w-full text-sm text-gray-900 border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" id="mce-LNAME" required="" />
                                        </div>
                                    </div>
                                    <div className="mc-field-group">
                                        <label for="mce-EMAIL" className="mb-2 text-sm font-medium">{blok.email_label} <span className="asterisk">*</span></label>
                                        <input type="email" name="EMAIL" value={email} onChange={e => setEmail(e.target.value)} className="required email block p-3  w-full text-sm text-gray-900 border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" id="mce-EMAIL" required="" />
                                    </div>
                                    <div className="mc-field-group">
                                        <label for="mce-COMPANY" className="mb-2 text-sm font-medium">{blok.company_label} <span className="asterisk">*</span></label>
                                        <input type="text" name="COMPANY" value={company} onChange={e => setCompany(e.target.value)} className="required text block p-3  w-full text-sm text-gray-900 border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" id="mce-COMPANY" required="" />
                                    </div>
                                    <div class="mc-field-group input-group">
                                        <ul>
                                            <li className="flex items-start">
                                                <input required="" type="checkbox" className="required relative shrink-0 w-4 h-4 border-2 border-primary checked:bg-primary checked:border-primary" name="MMERGE3" id="mce-MMERGE30" value="First Choice" />
                                                <label className="ms-2 text-sm text-gray-500 dark:text-gray-300" for="mce-MMERGE30">{blok.checkbox_label} *</label>
                                            </li>
                                        </ul>
                                    </div>
                                    <div id="mce-responses" className="clear mb-16">
