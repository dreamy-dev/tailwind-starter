                ...
                <figure className="max-w-screen-lg mx-auto">
                    ...
                    <blockquote>
                        <p className="text-3xl leading-relaxed font-medium text-gray-900 text-center dark:text-white">
                            <q>
                                Stadlers Antwort auf eine sich immer schneller
                                entwickelnde Bahnbranche: Innovative und
                                modulare Fahrzeugkonzepte für jedes
                                Marktsegment, die durch kurze
                                Entwicklungszeiten, hohe Wirtschaftlichkeit und
                                grosse Flexibilität überzeugen.
                            </q>
                        </p>
                    </blockquote>
