...
//               </svg>
//             </div>
//             <H4>Weltweit unterwegs, lokal verankert</H4>
...
//             </H4>
//             <p className="text-gray-500 dark:text-gray-400">
//               Individuelles Komplett-Angebot mit zentralem Ansprechpartner für
//               alle Anliegen betreffend Instandhaltung
//             </p>
//           </div>
//           <div>
//             <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primaryTrans-100 lg:h-12 lg:w-12 dark:bg-primary-900">
...
//             </H4>
//             <p className="text-gray-500 dark:text-gray-400">
//               Wir beteiligen uns bei der Risikoteilung und sorgen für Garantie:
//               Verfügbarkeits- und Zuverlässigkeitsgarantie sowie
...
const AdvantageItemComponent: React.FC<AdvantageItem> = ({
  icon,
  title,
  text,
}) => (
...
const Advantages: React.FC<AdvantagesProps> = ({ items }) => (
  <section className="bg-gray-50">
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
        <H2>Die Vorteile auf einen Blick</H2>
