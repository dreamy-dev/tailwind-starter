...
// export default function Testimonial(blok: any) {
//   return (
//     <>
...
//                   Bahnbranche: Innovative und modulare Fahrzeugkonzepte für
//                   jedes Marktsegment, die durch kurze Entwicklungszeiten, hohe
