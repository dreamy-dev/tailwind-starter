    ...
    return (
        <section className="py-16 lg:py-24">
            <ContentWidth {...storyblokEditable(blok)}>
                ...
                {/* <div className="col-span-12  mb-8">
                    <ul className="flex flex-col md:flex-cols-2 lg:flex-row gap-8 text-sm font-medium text-center text-gray-500 md:flex dark:text-gray-400">
                        <li className="w-full md:w-[18%] mb-4">
                            <select
                                className="w-full px-4 py-2 text-base border rounded block"
                                onChange={(e) => filterArticles(e, 'country')}
                            >
                                <option value="">
                                    {blok.filter_country_title}
                        ...
                        <li className="w-full md:w-[16%] mb-4 ">
                            <select
                                className="w-full px-4 py-2 text-base border rounded block"
                                onChange={(e) => filterArticles(e, 'category')}
                            >
                        ...
                        <li className="w-full md:md:w-[26%]">
                            <select
                                className="w-full px-4 py-2 text-base border rounded block"
                                onChange={(e) => filterArticles(e, 'product')}
                            >
                        ...
                        <li className="w-full md:w-[28%] mb-4 mr-2 lg:mr-4">
                            <div className="relative">
                                ...
                                <input
                                    className="w-full inline-block px-8 py-2 text-base rounded border hover:text-gray-900 hover:bg-gray-100"
                                    placeholder={blok.text_search}
