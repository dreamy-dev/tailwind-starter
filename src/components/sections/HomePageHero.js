        ...
        <div {...storyblokEditable(blok)} className="mx-auto w-full bg-white">
            <div className="relative inset-0 flex w-full flex-col-reverse items-center justify-end overflow-hidden md:flex-row">
                <motion.div
                    ...
                    className="relative left-0 w-full -translate-x-1/2 -translate-y-1/2 transform bg-contain bg-no-repeat md:absolute md:left-0 md:h-hero-bg-height-middle-screen md:w-[550px] lg:w-[550px] xl:h-hero-bg-height-extralarge-screen 2xl:w-[600px]"
                >
                    <div className="-mt-16 flex h-full w-full items-center justify-end pr-4 md:mt-0 md:pr-0">
                        <img
                            src="/Graph.svg"
                            className="block h-auto w-full md:h-[60vh]"
                    ...
                    <motion.div
                        ...
                        className="z-1 absolute top-4 flex h-4/5 w-3/6 max-w-[300px] -translate-y-1/2 translate-x-1/2 transform flex-col justify-center pb-16 md:left-0 md:top-8 md:ml-4 md:w-3/5 md:max-w-[330px] md:pb-0 xl:ml-20"
                    >
