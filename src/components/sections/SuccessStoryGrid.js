        ...
        <section className="overflow-hidden bg-white py-16 lg:py-24">
            <ContentWidth>
                <div className="col-span-12">
                    ...
                    <div className="flex flex-col items-center justify-between lg:pl-20 2xl:pl-0">
                        ...
                        >
                            <div className="relative flex w-full max-w-[100%] items-center">
                                <motion.div
                                    className="my-[-32px] ml-[-2px] mr-[-2px] flex flex-nowrap items-stretch gap-8 overflow-hidden py-[32px] pl-[2px] pr-[2px]"
                    ...
                    <div className="relative mt-8 flex w-full flex-row items-center justify-between lg:pl-20">
