...
const HeroCareer = ({blok}) => {
    ...
    {...storyblokEditable(blok)}
     className="bg-[url('/career1.jpg')] bg-no-repeat bg-cover bg-left bg-gray-400 bg-blend-multiply">
      <div className="relative py-24 px-4 mx-auto max-w-screen-xl text-white lg:pt-64 lg:pb-12 xl:px-0 z-1">
        <div className="mb-6 max-w-screen-md lg:mb-0 text-white">
          ...
          <br />
          <H1>{blok?.title}</H1>
          <Text styles="my-8 text-white lg:mb-8 text-xl">{blok?.subheading}</Text>
        </div>
        <form
          action="#"
