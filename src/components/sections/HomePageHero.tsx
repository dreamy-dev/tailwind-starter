      ...
      <div className="w-full max-h-[950px] overflow-hidden relative inset-0 flex flex-col-reverse md:flex-row items-center justify-end">
        ...
        >
          ...
          <motion.div
            ...
            className="z-1 absolute flex flex-col justify-center pb-16 md:pb-0 md:ml-4 xl:ml-40 h-4/5 top-0 md:w-3/5 md:top-8 md:left-0 transform -translate-y-1/2 translate-x-1/2 w-4/6 max-w-[270px] md:max-w-[330px]"
          >
