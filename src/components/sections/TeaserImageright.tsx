      ...
      <SmallWidth>
        <div className="grid grid-cols-1 gap-8 lg:gap-16 lg:grid-cols-2">
          <div>
            <div id="deviceTabContent" className="mt-8">
              <div className="">
                <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                  <div>
                    <H2 styles={`${titleColor}`}>{title}</H2>
                    <Text
                      styles={`mt-4 text-xl font-normal text-gray-800 ${leadTextColor}`}
                    >
                      {description}
                    </Text>
                  </div>
                  ...
                  <div className="pt-4 sm:pt-6 lg:pt-8">
                    ...
                    <Text
                      styles={`mt-6 text-xl font-normal text-gray-800 ${leadTextColor}`}
                    >
                      {text}
                    </Text>
                  </div>
            ...
            <img
              src={imageSrc}
              className="object-cover object-left h-[572px]"
              alt=""
            />
