                            ...
                            <div className="col-span-12 px-4 lg:px-0">
                                <div className="pt-5 flex flex-col sm:justify-between lg:justify-end lg:flex-row lg:flex lg:items-center gap-8 lg:gap-4">
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center dark:text-gray-300 hover:bg-gray-50 hover:text-primary text-primarySolid-800 font-medium rounded-lg text-base px-2.5 lg:px-5 py-2.5 dark:hover:bg-gray-700 focus:outline-none "
                                    >
                                        English
                                        <svg
                                            class="ml-1 w-4 h-4"
