    ...
    return (
        <div>
            ...
            <motion.div
                ...
                className="lg:absolute lg:top-14 z-20 lg:my-4 w-48 text-base list-none bg-white rounded divide-y divide-gray-100 shadow hover:cursor-pointer dark:bg-gray-700"
