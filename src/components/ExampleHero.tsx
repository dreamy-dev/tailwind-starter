    ...
    <div className="mx-auto max-w-screen-3xl bg-white">
      <div className="w-full mb-8 relative inset-0 flex flex-col-reverse md:flex-row items-center justify-end">
        <motion.div
          ...
          className="md:w-hero-bg-middle-screen lg:w-hero-bg-large-screen xl:w-hero-bg-extralarge-screen bg-contain md:h-hero-bg-height-middle-screen xl:h-hero-bg-height-extralarge-screen bg-no-repeat relative md:absolute left-0 transform -translate-y-1/2 -translate-x-1/2 "
        >
